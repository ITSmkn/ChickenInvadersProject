...
#include <memory>
#include "../../ChickenInvadersProject/Egg.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Egg_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Egg_t qt_meta_stringdata_Egg = {
    {
QT_MOC_LITERAL(0, 0, 3), // "Egg"
QT_MOC_LITERAL(1, 4, 8), // "MoveDown"
...
QT_INIT_METAOBJECT const QMetaObject Egg::staticMetaObject = { {
    &FallingItems::staticMetaObject,
    qt_meta_stringdata_Egg.data,
    qt_meta_data_Egg,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Egg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Egg.stringdata0))
