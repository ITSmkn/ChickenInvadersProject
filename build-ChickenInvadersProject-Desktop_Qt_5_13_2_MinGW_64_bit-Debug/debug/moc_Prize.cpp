...
#include <memory>
#include "../../ChickenInvadersProject/Prize.h"
...
struct qt_meta_stringdata_Prize_t {
    QByteArrayData data[3];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Prize_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Prize_t qt_meta_stringdata_Prize = {
    {
QT_MOC_LITERAL(0, 0, 5), // "Prize"
...
static const uint qt_meta_data_Prize[] = {
...
QT_INIT_METAOBJECT const QMetaObject Prize::staticMetaObject = { {
    &FallingItems::staticMetaObject,
    qt_meta_stringdata_Prize.data,
    qt_meta_data_Prize,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Prize::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Prize.stringdata0))
